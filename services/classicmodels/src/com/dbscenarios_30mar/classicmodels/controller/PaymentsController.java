...
@Api(value = "/classicmodels/Payments", description = "Exposes APIs to work with Payments resource.")
...
public class PaymentsController {
	...
	public Payments getPayments( @RequestParam("customerNumber") Integer customerNumber, @RequestParam("checkNumber") String checkNumber)
	...
	public Payments editPayments( @RequestParam("customerNumber") Integer customerNumber, @RequestParam("checkNumber") String checkNumber, @RequestBody Payments instance) throws EntityNotFoundException {
	    PaymentsId temp = new PaymentsId();
         temp.setCustomerNumber(customerNumber);
         temp.setCheckNumber(checkNumber);
