...
public class QueryExecutionController {
    ...
    @RequestMapping(value = "/queries/chartdata1", method = RequestMethod.GET)
    public Page<Object> executeChartdata1(@RequestParam(value = "data", required = false) java.lang.Integer data, Pageable pageable) throws QueryParameterMismatchException {
        LOGGER.debug("Executing named query chartdata1");
        Page<Object> result = queryService.executeChartdata1(pageable, data);
