...
@Service
public class AllO2M_O2OQueryExecutorServiceImpl implements AllO2M_O2OQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(AllO2M_O2OQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("AllO2M_O2OWMQueryExecutor")
