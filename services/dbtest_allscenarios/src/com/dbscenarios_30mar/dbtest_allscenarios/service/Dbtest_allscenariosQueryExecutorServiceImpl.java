...
@Service
public class Dbtest_allscenariosQueryExecutorServiceImpl implements Dbtest_allscenariosQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(Dbtest_allscenariosQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("dbtest_allscenariosWMQueryExecutor")
